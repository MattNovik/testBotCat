                ...
                <Scrollbars ref={dialogsPanel}>
                    <div className='botcat-dialogs-panel__content'>
                        <Dialog type='system'>
                            ...
                            <p>
                                Студсервис — это сервис помощи и консультаций студентам! Мы являемся
                                лидерами в этой сфере и вы всегда можете на нас рассчитывать.
                            </p>
                            <p>
                                Чтобы рассчитать цену наших услуг, ответьте на несколько вопросов
                                ниже:
                            </p>
