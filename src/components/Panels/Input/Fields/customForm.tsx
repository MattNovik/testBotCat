...
const CustomForm1: FC<IPropsCF> = memo(({
    name,
    placeholder,
    required,
    onSetValue
                ...
                view === 0 ? (
                    <div className='botcat-customform-name'>
                        <div className='botcat-customform-name__col'>
                            <Button kind='primary' onClick={() => setView(1)}>введите имя</Button>
                        </div>
                        <div className='botcat-customform-name__col'>
                            <Button kind='light' onClick={() => handleSetName('anonymous')}>анонимно</Button>
                        </div>
                    </div>
                ) : (
